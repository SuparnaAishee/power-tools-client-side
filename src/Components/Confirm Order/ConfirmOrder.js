...
const ConfirmOrder = ({ service }) => {
  ...
  const onSubmit = (data) => {
    ...
    fetch("https://vast-ocean-05710.herokuapp.com/allOrders", {
      method: "POST",
      headers: {
  ...
  return (
    <Card
      style={{ width: "30rem" }}
      className="d-flex justify-content-center align-content-center h-100 w-30"
    >
      <h2 className="my-3">Confirm Order</h2>
      <Card.Body className="text-center">
        <h3 className="service-cart-price">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <input
            className="service-form-submit bg-success"
            type="submit"
