        ...
        <Container>
          <div className="py-5">
            ...
            <Row
              xs={1}
              md={3}
              className="mx-auto g-4 align-content-center justify-content-center"
            >
              <Col className="">
                <div>
                  <div className="i-contact mx-auto mb-3 text-white">
                    {location}
                  </div>
                  <div className="">
            ...
            <div className="py-5">
              ...
              <div>
                ...
                <Button
                  className="form-control c-button py-3"
                  variant="primary"
                  type="submit"
                >
                  Send Message
